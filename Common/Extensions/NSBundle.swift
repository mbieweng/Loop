...
extension Bundle {
    ...
    var localizedNameAndVersion: String {
        ...
        return String(format: NSLocalizedString("%1$@ v%2$@ MB", comment: "The format string for the app name and version number. (1: bundle name)(2: bundle version)"), displayName, shortVersionString)
    }
